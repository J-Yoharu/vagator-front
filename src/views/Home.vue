        ...
        <div class="flex justify-between mb-5">
          ...
          <form action="" class="mb-10">
            ...
            <div class="bg-white w-full p-1 border rounded-md inline-flex items-center">
              ...
              <input type="text" class="w-full text-lg py-5 leading-tight focus:outline-none placeholder-gray-600" placeholder="Pesquisar vagas de emprego...">
            </div>
            ...
            <div class="mt-5 flex justify-around mb-6">
              ...
              <div class="w-full mr-5 text-gray-600">
                <select name="opcoes" class="p-3 text-lg w-full rounded-lg border" placeholder="Local">
                  ...
                  <option value="outro">V-FOR</option>
                </select>
              </div>
              ...
              <label for="toggle" class="text-lg font-bold text-gray-600">Somente remoto</label>
              </div>
          
            </div>
          </form>

          <job-card v-for="n in 5" :key="n"/>
